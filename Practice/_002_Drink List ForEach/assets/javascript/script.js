...
// iterate through the drinkList array using a forEach loop
drinkList.forEach(function (drinkList)
    {
	    ...
	    newDrink.textContent = drinkList;        // assign the text of the paragraph to be the text in the array
