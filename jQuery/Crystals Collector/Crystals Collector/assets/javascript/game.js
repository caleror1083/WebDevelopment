$(document).ready(function() {
	...
	// Create a function that generates the random number so we can call it later
	var randomNumber = 0;
	var greenGemNmbr = 0;
	var redGemNmbr = 0;
	var yellowGemNmbr = 0;
	...
	function randomNumberGenerator() {
		...
		$("#randomNumberId").html(randomNumber);	// Add this new random number to the HTML page
	}
